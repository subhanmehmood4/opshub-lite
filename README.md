...
- **AI Copilot** — Groq-powered answers grounded in `lib/demoData.ts`
...
- Supabase (Auth)
- Recharts
- Groq API (`llama-3.3-70b-versatile`) — free tier available
...
|----------|----------|-------------|
| `GROQ_API_KEY` | Yes (copilot) | [Groq Console](https://console.groq.com/keys) API key |
...
opshub-lite/
  ...
  lib/
    ...
    groq.ts               Copilot prompt + Groq API call
